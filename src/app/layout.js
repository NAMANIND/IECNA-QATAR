...
export const metadata = {
  ...
  description:
    " Join industry leaders at the 4th edition of Influence Exchange Confex & Awards Series for insights, networking, and recognition in the world of influence marketing.",
};
